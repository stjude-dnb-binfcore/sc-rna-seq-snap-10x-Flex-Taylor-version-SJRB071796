...
# Purpose:       Launch the full sc-rna-seq-snap-10x-Flex pipeline on LSF as a dependency-
#                aware job chain, with fully OPTIONAL steps and adaptive waits.
#
# Summary:
#   - Submits the end-to-end sc-rna-seq-snap-10x-Flex workflow (A→J) to LSF.
...
RUN_DE_GO=1                 # H: DE GO analysis: `de-go-analysis`
...
# ------------------------------------------------------------------------------
echo "============================================================"
echo " Launching sc-rna-seq-snap-10x-Flex pipeline (LSF job chain) — optional steps"
